...
// in e_commerce_app/test/auth_repoImplementation/auth_repoImplementation_test.dart.
...
class MockAuthApiService extends _i1.Mock implements _i4.AuthApiService {
  ...
  @override
  _i5.Future<_i3.Response<dynamic>> login({
  ...
  @override
  _i5.Future<_i3.Response<dynamic>> resetOtp({
    required _i8.ForgotPasswordRequestBody? body,
  }) =>
      (super.noSuchMethod(
            Invocation.method(#resetOtp, [], {#body: body}),
            returnValue: _i5.Future<_i3.Response<dynamic>>.value(
              _FakeResponse_1<dynamic>(
                this,
                Invocation.method(#resetOtp, [], {#body: body}),
